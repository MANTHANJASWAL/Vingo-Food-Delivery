      ...
      >
        ...
        <div className="mb-4">
          ...
          <input
            ...
            style={{ border: `1px solid ${borderColor}` }} onChange={(e)=>setEmail(e.target.value)}
        ...
        <div className="mb-4">
          ...
          <input
            ...
            style={{ border: `1px solid ${borderColor}` }} onChange={(e)=>setMobile(e.target.value)}
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <input
              ...
              style={{ border: `1px solid ${borderColor}` }} onChange={(e)=>setPassword(e.target.value)}
        ...
        <p className='text-center mt-5' onClick={()=>navigate("/signin")}>Already have an account?<span className='text-[#ff4d2d]'>Sign In</span></p>
      </div>
    </div>
  );
}
